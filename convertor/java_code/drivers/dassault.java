...
public class dassault
{
	...
	public static InitDriverPtr init_dassault = new InitDriverPtr() { public void handler() (void)
	{
	...
	public static InitDriverPtr init_thndzone = new InitDriverPtr() { public void handler() (void)
	{
		const data8_t *src = memory_region(REGION_GFX1);
		data8_t *dst = memory_region(REGION_GFX2);
		data8_t *tmp = (data8_t *)malloc(0x80000);
