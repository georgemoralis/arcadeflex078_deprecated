...
public class welltris
{
	...
	public static InitDriverPtr init_welltris = new InitDriverPtr() { public void handler() (void)
	{
	#if WELLTRIS_4P_HACK
	...
	public static InitDriverPtr init_quiz18k = new InitDriverPtr() { public void handler() (void)
	{
		;
	} };
