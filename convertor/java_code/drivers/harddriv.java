...
public class harddriv
{
	...
	*/
	...
	public static InitDriverPtr init_multisync = new InitDriverPtr() { public void handler() (int compact_inputs)
	{
		/* assume we're first to be called */
		find_cpus();
	...
	*/
	...
	public static InitDriverPtr init_dsk2 = new InitDriverPtr() { public void handler() (void)
	{
		/* install ASIC65 */
	...
	public static InitDriverPtr init_dspcom = new InitDriverPtr() { public void handler() (void)
	{
		/* install ASIC65 */
