...
/*TODO*///	size_t				ramlength;			/* RAM length pointer */
/*TODO*///	opbase_handler 		opbase;				/* opcode base handler */
/*TODO*///
/*TODO*///	void *				op_ram;				/* dynamic RAM base pointer */
/*TODO*///	void *				op_rom;				/* dynamic ROM base pointer */
/*TODO*///	offs_t				op_mem_min;			/* dynamic ROM/RAM min */
/*TODO*///	offs_t				op_mem_max;			/* dynamic ROM/RAM max */
/*TODO*///	UINT8		 		opcode_entry;		/* opcode base handler */
/*TODO*///
...
/*TODO*///-------------------------------------------------*/
/*TODO*///
/*TODO*///static int					cur_context;					/* current CPU context */
/*TODO*///
/*TODO*///UINT8 *						OP_ROM;							/* opcode ROM base */
/*TODO*///UINT8 *						OP_RAM;							/* opcode RAM base */
/*TODO*///offs_t						OP_MEM_MIN;						/* opcode memory minimum */
/*TODO*///offs_t						OP_MEM_MAX;						/* opcode memory maximum */
...
/*TODO*///int ext_entries = 0;										/* number of entries ext_memory[] entries used */
/*TODO*///struct ExtMemory			ext_memory[MAX_EXT_MEMORY];		/* externally-allocated memory */
/*TODO*///
/*TODO*///static data32_t				unmap_value;					/* unmapped memory value */
/*TODO*///
...
/*TODO*///#endif
/*TODO*///
/*TODO*///	/* no current context to start */
/*TODO*///	cur_context = -1;
/*TODO*///	unmap_value = 0;
/*TODO*///
...
/*TODO*///{
/*TODO*///	if (cur_context == cpunum)
/*TODO*///	{
/*TODO*///		OP_ROM = base;
/*TODO*///		OP_MEM_MIN = (offs_t) 0x00000000;
/*TODO*///		OP_MEM_MAX = (offs_t) 0x7fffffff;
/*TODO*///	}
/*TODO*///	else
/*TODO*///	{
/*TODO*///		cpudata[cpunum].op_rom = base;
/*TODO*///		cpudata[cpunum].op_mem_min = (offs_t) 0x00000000;
/*TODO*///		cpudata[cpunum].op_mem_max = (offs_t) 0x7fffffff;
/*TODO*///	}
/*TODO*///}
/*TODO*///
/*TODO*///
...
/*TODO*///{
/*TODO*///	/* remember dynamic RAM/ROM */
/*TODO*///	if (cur_context != -1)
/*TODO*///	{
/*TODO*///		cpudata[cur_context].op_ram = OP_RAM;
/*TODO*///		cpudata[cur_context].op_rom = OP_ROM;
/*TODO*///		cpudata[cur_context].op_mem_min = OP_MEM_MIN;
/*TODO*///		cpudata[cur_context].op_mem_max = OP_MEM_MAX;
/*TODO*///		cpudata[cur_context].opcode_entry = opcode_entry;
/*TODO*///	}
/*TODO*///	cur_context = activecpu;
/*TODO*///
/*TODO*///	cpu_bankbase[STATIC_RAM] = cpudata[activecpu].rambase;
/*TODO*///	OP_RAM = cpudata[activecpu].op_ram;
/*TODO*///	OP_ROM = cpudata[activecpu].op_rom;
/*TODO*///	OP_MEM_MIN = cpudata[activecpu].op_mem_min;
/*TODO*///	OP_MEM_MAX = cpudata[activecpu].op_mem_max;
/*TODO*///	opcode_entry = opcode_entry;
/*TODO*///
...
/*TODO*///
/*TODO*////*-------------------------------------------------
/*TODO*///	memory_set_unmap_value - set the unmapped
/*TODO*///	memory value
/*TODO*///-------------------------------------------------*/
/*TODO*///
/*TODO*///void memory_set_unmap_value(data32_t value)
/*TODO*///{
/*TODO*///	unmap_value = value;
/*TODO*///}
/*TODO*///
/*TODO*///
/*TODO*////*-------------------------------------------------
...
/*TODO*///{
/*TODO*///	struct memport_data *memport = &cpudata[cpunum].mem;
/*TODO*///	struct handler_data *handlist = (memport->dbits == 32) ? rmemhandler32 : (memport->dbits == 16) ? rmemhandler16 : rmemhandler8;
/*TODO*///	UINT8 minbits = memport->abits - memport->ebits;
/*TODO*///	UINT8 entry;
/*TODO*///
/*TODO*///	/* perform the lookup */
/*TODO*///	offset &= memport->mask;
/*TODO*///	entry = memport->read.table[LEVEL1_INDEX(offset, memport->abits, minbits)];
/*TODO*///	if (entry >= SUBTABLE_BASE)
/*TODO*///		entry = memport->read.table[LEVEL2_INDEX(entry, offset, memport->abits, minbits)];
/*TODO*///
/*TODO*///	/* 8-bit case: RAM/ROM/RAMROM */
/*TODO*///	if (entry > STATIC_RAM || (minbits == 0 && entry != STATIC_RAM))
/*TODO*///		return NULL;
/*TODO*///	offset -= handlist[entry].offset;
/*TODO*///	return &cpu_bankbase[entry][offset];
/*TODO*///}
/*TODO*///
/*TODO*///
/*TODO*////*-------------------------------------------------
/*TODO*///	memory_get_write_ptr - return a pointer to the
/*TODO*///	base of RAM associated with the given CPU
/*TODO*///	and offset
/*TODO*///-------------------------------------------------*/
/*TODO*///
...
/*TODO*///{
/*TODO*///	struct memport_data *memport = &cpudata[cpunum].mem;
/*TODO*///	struct handler_data *handlist = (memport->dbits == 32) ? wmemhandler32 : (memport->dbits == 16) ? wmemhandler16 : wmemhandler8;
/*TODO*///	UINT8 minbits = memport->abits - memport->ebits;
/*TODO*///	UINT8 entry;
/*TODO*///
/*TODO*///	/* perform the lookup */
/*TODO*///	offset &= memport->mask;
/*TODO*///	entry = memport->write.table[LEVEL1_INDEX(offset, memport->abits, minbits)];
/*TODO*///	if (entry >= SUBTABLE_BASE)
/*TODO*///		entry = memport->write.table[LEVEL2_INDEX(entry, offset, memport->abits, minbits)];
/*TODO*///
/*TODO*///	/* 8-bit case: RAM/ROM/RAMROM */
/*TODO*///	if (entry > STATIC_RAM || (minbits == 0 && entry != STATIC_RAM))
/*TODO*///		return NULL;
...
/*TODO*///		tabledata->handlers[handler].top = stop;
/*TODO*///	}
/*TODO*///
...
/*TODO*///GENERATE_MEM_HANDLERS_16BIT_BE(18)
...
/*TODO*///
/*TODO*///GENERATE_MEM_HANDLERS_32BIT_LE(24)
...
/*TODO*///GENERATE_PORT_HANDLERS_32BIT_LE(32)
/*TODO*///
/*TODO*///
/*TODO*////*-------------------------------------------------
/*TODO*///	safe opcode reading
/*TODO*///-------------------------------------------------*/
/*TODO*///
/*TODO*///data8_t cpu_readop_safe(offs_t offset)
/*TODO*///{
/*TODO*///	activecpu_set_op_base(offset);
/*TODO*///	return cpu_readop_unsafe(offset);
/*TODO*///}
/*TODO*///
/*TODO*///data16_t cpu_readop16_safe(offs_t offset)
/*TODO*///{
/*TODO*///	activecpu_set_op_base(offset);
/*TODO*///	return cpu_readop16_unsafe(offset);
/*TODO*///}
/*TODO*///
/*TODO*///data32_t cpu_readop32_safe(offs_t offset)
/*TODO*///{
/*TODO*///	activecpu_set_op_base(offset);
/*TODO*///	return cpu_readop32_unsafe(offset);
/*TODO*///}
/*TODO*///
/*TODO*///data8_t cpu_readop_arg_safe(offs_t offset)
/*TODO*///{
/*TODO*///	activecpu_set_op_base(offset);
/*TODO*///	return cpu_readop_arg_unsafe(offset);
/*TODO*///}
/*TODO*///
/*TODO*///data16_t cpu_readop_arg16_safe(offs_t offset)
/*TODO*///{
/*TODO*///	activecpu_set_op_base(offset);
/*TODO*///	return cpu_readop_arg16_unsafe(offset);
/*TODO*///}
/*TODO*///
/*TODO*///data32_t cpu_readop_arg32_safe(offs_t offset)
/*TODO*///{
/*TODO*///	activecpu_set_op_base(offset);
/*TODO*///	return cpu_readop_arg32_unsafe(offset);
/*TODO*///}
/*TODO*///
/*TODO*///
/*TODO*////*-------------------------------------------------
