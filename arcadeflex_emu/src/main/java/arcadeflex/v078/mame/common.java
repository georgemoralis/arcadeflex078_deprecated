...
/*TODO*///
/*TODO*////* disks */
/*TODO*///static struct chd_file *disk_handle[4];
/*TODO*///
/*TODO*////* system BIOS */
...
/*TODO*///		linearraysize = (linearraysize + 15) & ~15;
/*TODO*///
...
/*TODO*///
/*TODO*////*-------------------------------------------------
/*TODO*///	auto_strdup - allocate auto-freeing string
/*TODO*///-------------------------------------------------*/
/*TODO*///
/*TODO*///char *auto_strdup(const char *str)
/*TODO*///{
/*TODO*///	char *new_str = auto_malloc(strlen(str) + 1);
/*TODO*///	if (!new_str)
/*TODO*///		return NULL;
/*TODO*///	strcpy(new_str, str);
/*TODO*///	return new_str;
/*TODO*///}
/*TODO*///
/*TODO*///
...
/*TODO*///	struct mame_bitmap *osdcopy;
/*TODO*///	UINT32 saved_rgb_components[3];
/*TODO*///
/*TODO*///	/* allow the artwork system to override certain parameters */
/*TODO*///	bounds = Machine->visible_area;
/*TODO*///	memcpy(saved_rgb_components, direct_rgb_components, sizeof(direct_rgb_components));
/*TODO*///	artwork_override_screenshot_params(&bitmap, &bounds, direct_rgb_components);
/*TODO*///
/*TODO*///	/* allow the OSD system to muck with the screenshot */
/*TODO*///	osdcopy = osd_override_snapshot(bitmap, &bounds);
/*TODO*///	if (osdcopy)
/*TODO*///		bitmap = osdcopy;
/*TODO*///
/*TODO*///	/* now do the actual work */
...
/*TODO*///			int x,y,sx,sy;
/*TODO*///
/*TODO*///			sx = bounds.min_x;
/*TODO*///			sy = bounds.min_y;
/*TODO*///
...
/*TODO*///		}
/*TODO*///	}
/*TODO*///	memcpy(direct_rgb_components, saved_rgb_components, sizeof(saved_rgb_components));
/*TODO*///
/*TODO*///	/* if the OSD system allocated a bitmap; free it */
/*TODO*///	if (osdcopy)
/*TODO*///		bitmap_free(osdcopy);
/*TODO*///}
/*TODO*///
/*TODO*///
/*TODO*///
...
/*TODO*///{
/*TODO*///	return disk_handle[diskindex];
/*TODO*///}
/*TODO*///
/*TODO*///
/*TODO*///
...
/*TODO*///
/*TODO*////*-------------------------------------------------
/*TODO*///	determine_bios_rom - determine system_bios
/*TODO*///	from SystemBios structure and options.bios
/*TODO*///-------------------------------------------------*/
/*TODO*///
/*TODO*///int determine_bios_rom(const struct SystemBios *bios)
/*TODO*///{
/*TODO*///	const struct SystemBios *firstbios = bios;
/*TODO*///
/*TODO*///	/* set to default */
/*TODO*///	int bios_no = 0;
/*TODO*///
/*TODO*///	/* Not system_bios_0 and options.bios is set  */
/*TODO*///	if(bios && (options.bios != NULL))
/*TODO*///	{
/*TODO*///		/* Allow '-bios n' to still be used */
/*TODO*///		while(!BIOSENTRY_ISEND(bios))
/*TODO*///		{
/*TODO*///			char bios_number[3];
/*TODO*///			sprintf(bios_number, "%d", bios->value);
/*TODO*///
/*TODO*///			if(!strcmp(bios_number, options.bios))
/*TODO*///				bios_no = bios->value;
/*TODO*///
/*TODO*///			bios++;
/*TODO*///		}
/*TODO*///
/*TODO*///		bios = firstbios;
/*TODO*///
/*TODO*///		/* Test for bios short names */
/*TODO*///		while(!BIOSENTRY_ISEND(bios))
/*TODO*///		{
/*TODO*///			if(!strcmp(bios->_name, options.bios))
/*TODO*///				bios_no = bios->value;
/*TODO*///
/*TODO*///			bios++;
/*TODO*///		}
/*TODO*///	}
/*TODO*///
/*TODO*///	debugload("Using System BIOS: %d\n", bios_no);
/*TODO*///
/*TODO*///	return bios_no;
/*TODO*///}
/*TODO*///
...
/*TODO*///	int count = 0;
/*TODO*///
/*TODO*///	/* determine the correct biosset to load based on options.bios string */
/*TODO*///	int this_bios = determine_bios_rom(Machine->gamedrv->bios);
/*TODO*///
...
/*TODO*///			if (!ROM_GETBIOSFLAGS(romp) || (ROM_GETBIOSFLAGS(romp) == (this_bios+1))) /* alternate bios sets */
/*TODO*///				count++;
/*TODO*///
...
/*TODO*///
/*TODO*////*-------------------------------------------------
/*TODO*///	dump_wrong_and_correct_checksums - dump an
/*TODO*///	error message containing the wrong and the
/*TODO*///	correct checksums for a given ROM
/*TODO*///-------------------------------------------------*/
/*TODO*///
/*TODO*///static void dump_wrong_and_correct_checksums(struct rom_load_data* romdata, const char* hash, const char* acthash)
/*TODO*///{
/*TODO*///	unsigned i;
/*TODO*///	char chksum[256];
/*TODO*///	unsigned found_functions;
/*TODO*///	unsigned wrong_functions;
/*TODO*///
/*TODO*///	found_functions = hash_data_used_functions(hash) & hash_data_used_functions(acthash);
/*TODO*///
/*TODO*///	hash_data_print(hash, found_functions, chksum);
/*TODO*///	sprintf(&romdata->errorbuf[strlen(romdata->errorbuf)], "    EXPECTED: %s\n", chksum);
/*TODO*///
/*TODO*///	/* We dump informations only of the functions for which MAME provided
/*TODO*///		a correct checksum. Other functions we might have calculated are
/*TODO*///		useless here */
/*TODO*///	hash_data_print(acthash, found_functions, chksum);
/*TODO*///	sprintf(&romdata->errorbuf[strlen(romdata->errorbuf)], "       FOUND: %s\n", chksum);
/*TODO*///
/*TODO*///	/* For debugging purposes, we check if the checksums available in the
/*TODO*///	   driver are correctly specified or not. This can be done by checking
/*TODO*///	   the return value of one of the extract functions. Maybe we want to
/*TODO*///	   activate this only in debug buils, but many developers only use
/*TODO*///	   release builds, so I keep it as is for now. */
/*TODO*///	wrong_functions = 0;
/*TODO*///	for (i=0;i<HASH_NUM_FUNCTIONS;i++)
/*TODO*///		if (hash_data_extract_printable_checksum(hash, 1<<i, chksum) == 2)
/*TODO*///			wrong_functions |= 1<<i;
/*TODO*///
/*TODO*///	if (wrong_functions)
/*TODO*///	{
/*TODO*///		for (i=0;i<HASH_NUM_FUNCTIONS;i++)
/*TODO*///			if (wrong_functions & (1<<i))
/*TODO*///			{
/*TODO*///				sprintf(&romdata->errorbuf[strlen(romdata->errorbuf)],
/*TODO*///					"\tInvalid %s checksum treated as 0 (check leading zeros)\n",
/*TODO*///					hash_function_name(1<<i));
/*TODO*///
/*TODO*///				romdata->warnings++;
/*TODO*///			}
/*TODO*///	}
...
/*TODO*///
/*TODO*////*-------------------------------------------------
/*TODO*///	verify_length_and_hash - verify the length
/*TODO*///	and hash signatures of a file
/*TODO*///-------------------------------------------------*/
/*TODO*///
/*TODO*///static void verify_length_and_hash(struct rom_load_data *romdata, const char *name, UINT32 explength, const char* hash)
/*TODO*///{
/*TODO*///	UINT32 actlength;
/*TODO*///	const char* acthash;
/*TODO*///
...
/*TODO*///	acthash = mame_fhash(romdata->file);
/*TODO*///
/*TODO*///	/* verify length */
...
/*TODO*///	}
/*TODO*///
/*TODO*///	/* If there is no good dump known, write it */
...
/*TODO*///	else if (!hash_data_is_equal(hash, acthash, 0))
/*TODO*///	{
/*TODO*///		/* otherwise, it's just bad */
/*TODO*///		sprintf(&romdata->errorbuf[strlen(romdata->errorbuf)], "%-12s WRONG CHECKSUMS:\n", name);
/*TODO*///
/*TODO*///		dump_wrong_and_correct_checksums(romdata, hash, acthash);
/*TODO*///
/*TODO*///		romdata->warnings++;
/*TODO*///	}
/*TODO*///	/* If it matches, but it is actually a bad dump, write it */
/*TODO*///	else if (hash_data_has_info(hash, HASH_INFO_BAD_DUMP))
/*TODO*///	{
...
/*TODO*///	up the parent and loading by checksum
/*TODO*///-------------------------------------------------*/
/*TODO*///
...
/*TODO*///       return 0;
/*TODO*///
/*TODO*///	/* Attempt reading up the chain through the parents. It automatically also
/*TODO*///	   attempts any kind of load by checksum supported by the archives. */
/*TODO*///	romdata->file = NULL;
/*TODO*///	for (drv = Machine->gamedrv; !romdata->file && drv; drv = drv->clone_of)
/*TODO*///		if (drv->name && *drv->name)
/*TODO*///			romdata->file = mame_fopen_rom(drv->name, ROM_GETNAME(romp), ROM_GETHASHDATA(romp));
/*TODO*///
/*TODO*///	/* return the result */
...
/*TODO*///	}
/*TODO*///
/*TODO*///	/* fill the data (filling value is stored in place of the hashdata) */
/*TODO*///	memset(base, (UINT32)ROM_GETHASHDATA(romp) & 0xff, numbytes);
/*TODO*///	return 1;
/*TODO*///}
/*TODO*///
/*TODO*///
...
/*TODO*///	UINT32 numbytes = ROM_GETLENGTH(romp);
/*TODO*///	UINT32 srcoffs = (UINT32)ROM_GETHASHDATA(romp);  /* srcoffset in place of hashdata */
/*TODO*///	UINT8 *srcbase;
/*TODO*///
...
/*TODO*///		{
/*TODO*///			if (!ROM_GETBIOSFLAGS(romp) || (ROM_GETBIOSFLAGS(romp) == (system_bios+1))) /* alternate bios sets */
/*TODO*///			{
...
/*TODO*///					if (baserom)
/*TODO*///					{
/*TODO*///						debugload("Verifying length (%X) and checksums\n", explength);
/*TODO*///						verify_length_and_hash(romdata, ROM_GETNAME(baserom), explength, ROM_GETHASHDATA(baserom));
/*TODO*///						debugload("Verify finished\n");
/*TODO*///					}
/*TODO*///
...
/*TODO*///		{
/*TODO*///			struct chd_file *source, *diff = NULL;
/*TODO*///			struct chd_header header;
/*TODO*///			char filename[1024], *c;
/*TODO*///			char acthash[HASH_BUF_SIZE];
/*TODO*///			int err;
/*TODO*///
...
/*TODO*///			source = chd_open(filename, 0, NULL);
/*TODO*///			if (!source)
/*TODO*///			{
/*TODO*///				if (chd_get_last_error() == CHDERR_UNSUPPORTED_VERSION)
/*TODO*///					sprintf(&romdata->errorbuf[strlen(romdata->errorbuf)], "%-12s UNSUPPORTED CHD VERSION\n", filename);
/*TODO*///				else
/*TODO*///					sprintf(&romdata->errorbuf[strlen(romdata->errorbuf)], "%-12s NOT FOUND\n", filename);
/*TODO*///				romdata->errors++;
/*TODO*///				romp++;
...
/*TODO*///			}
/*TODO*///
/*TODO*///			/* get the header and extract the MD5/SHA1 */
/*TODO*///			header = *chd_get_header(source);
/*TODO*///			hash_data_clear(acthash);
/*TODO*///			hash_data_insert_binary_checksum(acthash, HASH_MD5, header.md5);
/*TODO*///			hash_data_insert_binary_checksum(acthash, HASH_SHA1, header.sha1);
/*TODO*///
/*TODO*///			/* verify the MD5 */
/*TODO*///			if (!hash_data_is_equal(ROM_GETHASHDATA(romp), acthash, 0))
/*TODO*///			{
/*TODO*///				sprintf(&romdata->errorbuf[strlen(romdata->errorbuf)], "%-12s WRONG CHECKSUMS:\n", filename);
/*TODO*///				dump_wrong_and_correct_checksums(romdata, ROM_GETHASHDATA(romp), acthash);
/*TODO*///				romdata->warnings++;
/*TODO*///			}
/*TODO*///
/*TODO*///			/* if not read-only, make the diff file */
/*TODO*///			if (!DISK_ISREADONLY(romp))
/*TODO*///			{
...
/*TODO*///				diff = chd_open(filename, 1, source);
/*TODO*///				if (!diff)
/*TODO*///				{
/*TODO*///					/* didn't work; try creating it instead */
/*TODO*///					debugload("Creating differencing image: %s\n", filename);
/*TODO*///					err = chd_create(filename, 0, 0, CHDCOMPRESSION_NONE, source);
/*TODO*///					if (err != CHDERR_NONE)
/*TODO*///					{
/*TODO*///						if (chd_get_last_error() == CHDERR_UNSUPPORTED_VERSION)
/*TODO*///							sprintf(&romdata->errorbuf[strlen(romdata->errorbuf)], "%-12s UNSUPPORTED CHD VERSION\n", filename);
/*TODO*///						else
...
/*TODO*///			disk_handle[DISK_GETINDEX(romp)] = DISK_ISREADONLY(romp) ? source : diff;
/*TODO*///			romp++;
/*TODO*///		}
/*TODO*///	}
/*TODO*///	return 1;
...
/*TODO*///	memset(disk_handle, 0, sizeof(disk_handle));
/*TODO*///
/*TODO*///	/* determine the correct biosset to load based on options.bios string */
/*TODO*///	system_bios = determine_bios_rom(Machine->gamedrv->bios);
/*TODO*///
